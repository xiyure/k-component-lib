...
- 还原advancedScreening示例 - ([90bfdd2](https://github.com/xiyure/k-component-lib/commit/90bfdd28b60938ff55f3dfc02bc6ccd1eda55817))
...
- 修复穿梭框无法选择一级路由问题 - ([5bd2620](https://github.com/xiyure/k-component-lib/commit/5bd2620ff753ff6758c575f8de20270650fee651))
...
2.表格搜索功能优化，搜索时自动过滤特殊类型数据； - ([357d871](https://github.com/xiyure/k-component-lib/commit/357d8716d143cf02362a0bfeed4acb540efb2d20))
...
- 1.filterForm组件参数和方法拓展； - ([1c803e5](https://github.com/xiyure/k-component-lib/commit/1c803e512cc73bdb3780b52f8b314a1c9ab5b6ef))
...
2.upload组件代码结构优化； - ([62d4cb0](https://github.com/xiyure/k-component-lib/commit/62d4cb014653987342e4bf3c91e613c0e51514ef))
...
- 2.打包时生成.d.ts文件; - ([ce4e9f3](https://github.com/xiyure/k-component-lib/commit/ce4e9f3b6226bef3dcdc51a8d28f06362454f58f))
...
- 完成输表格示例 - ([1e06fe5](https://github.com/xiyure/k-component-lib/commit/1e06fe5afa4844e822b076254c763878264843ba))
...
2.filter组件添加formatter参数，支持对日期的格式化；
...
- 更新工作流 - ([f4580fc](https://github.com/xiyure/k-component-lib/commit/f4580fc1323c831885803e71051922aa169419d1))
- 更新文档 - ([8ffa17e](https://github.com/xiyure/k-component-lib/commit/8ffa17eec664fdda3ba55c005206dd6c3751a709))
- Add dependencies lock file - ([1362164](https://github.com/xiyure/k-component-lib/commit/136216444d253f7742250a5f3425df0bbba12a10))
- 分离 vite 配置, 新增自动化部署 - ([1f4372e](https://github.com/xiyure/k-component-lib/commit/1f4372e69b8888cf90d248028d46e445df302894))
- 1.修复组件库部分情况下控制台出现警告问题 - ([11ed8cf](https://github.com/xiyure/k-component-lib/commit/11ed8cf1dc5c9425060971dcae8320f8f4afce1f))
- 1.组件库文档script指令修改； - ([8d5f0af](https://github.com/xiyure/k-component-lib/commit/8d5f0af4953133b7d6e1e5082477ce06a0c6e4c1))
- 删除 vitepress 相关插件 - ([ef7c19e](https://github.com/xiyure/k-component-lib/commit/ef7c19e298201531b7ef974649bfb531bbaf4ed0))
- 1.新增tree-table组件文档；
2.组件库文档工程优化，支持多级参数表格嵌套； - ([740d5f1](https://github.com/xiyure/k-component-lib/commit/740d5f1defe0ac6009777cadc347a2347fb7609c))
...
- 新增阅读增强和滚动条插件 - ([094165f](https://github.com/xiyure/k-component-lib/commit/094165fe529c6a7d6bf319df6ef34ecefdc9c164))
- Sidebar 自动读取目录下文件, 新增翻译, 更新文档内容 - ([ecf2107](https://github.com/xiyure/k-component-lib/commit/ecf2107695b965c04825b5f481e25d0587cfea83))
...
- 1.组件文档新增打包个功能； - ([57a8cf0](https://github.com/xiyure/k-component-lib/commit/57a8cf0dbbd00d47318720a8c1d55614187d74bb))
- 1.表格排序支持分页场景； - ([244d661](https://github.com/xiyure/k-component-lib/commit/244d66147f4faf97e83bba3601482ac38426813c))
- 1.tree-table组件数据更新时清空批量操作的选中状态；
2.vxe-table版本升级：优化checkbox模块操作效率；
3.重写vxe-table的insert、insertAt和insertNextAt方法，支持树形结构，暂不支持懒加载； - ([2001e62](https://github.com/xiyure/k-component-lib/commit/2001e62ef16b515945626fa835a292f21ca81c50))
- 1.添加Button组件API文档；
2.组件文档界面优化； - ([fc46c0a](https://github.com/xiyure/k-component-lib/commit/fc46c0a2d907404dd5099faec194e9ca5e42346e))
- 1.组件文档：新增参数表格文字提示功能；
2.组件文档：js文件重构至ts文件；
3.组件文档：md文件样式优化 - ([9c1189e](https://github.com/xiyure/k-component-lib/commit/9c1189ed0ef8507b8d03b6735fe6ed1f7fb07a1e))
- 1.删除测试文件； - ([2c3154a](https://github.com/xiyure/k-component-lib/commit/2c3154a6dbee91028f84309c1924bba283c9adf1))
- 1.组件库文档工程优化，支持API文档自动生成； - ([f8794f8](https://github.com/xiyure/k-component-lib/commit/f8794f88a826b678fbb5b16b6c1c7c64ac0cb15c))
- 1.修复表格组件数据刷新不及时问题； - ([bc49f71](https://github.com/xiyure/k-component-lib/commit/bc49f71f539e3015b9a08587b23f26e77b7aafc3))
- 1.组件库所有组件引入全局配置样式文件； - ([f57a0db](https://github.com/xiyure/k-component-lib/commit/f57a0db1a2d41451e706171e9f49bc95e48a55ee))
- 1.项目增加styleModule参数为不同的业务场景提供不同样式；
2.组件相关业务场景类名添加； - ([df08bbd](https://github.com/xiyure/k-component-lib/commit/df08bbdf9fa6e339644896b9d62f30c0549480fb))
...
- 1.修复popover组件部分Element方法无法使用问题； - ([6188f3f](https://github.com/xiyure/k-component-lib/commit/6188f3f6a0b5bf3b2b2eba11125e28654cb84b80))
...
- 1.组件库所有第三方依赖组件按需导入； - ([a2e1ab5](https://github.com/xiyure/k-component-lib/commit/a2e1ab5ca5c27e1fb4e7b3b7d462d1f1866cf05c))
...
- 1.修复tree-table组件表头工具栏按钮多次点击后阴影加深问题；
2.修复filter组件日期比较错误问题；
3.新增tab组件标签栏文本长度溢出时显示文字提示功能； - ([3de07b7](https://github.com/xiyure/k-component-lib/commit/3de07b7d78c905f99d2122e19cd5e9ce61ef20b0))
- 1.table组件列折叠后支持展开时保持与折叠前宽度一致；
2.表格列头筛选面板后支持点击其他空白处时关闭面板；
3.表头筛选图标更换； - ([3646892](https://github.com/xiyure/k-component-lib/commit/364689218914a62ac5cff0fb04a2238653d3ee89))
...
- 1.组件库文档集成； - ([9e20573](https://github.com/xiyure/k-component-lib/commit/9e205739b82ac9fa6625727f320cea20b3ae4912))
- KtreeTable, 刷新按钮默认打开 - ([1fa0449](https://github.com/xiyure/k-component-lib/commit/1fa0449be610d75ce4d8fbd008c2babf60baaeea))
- 1.修复表格数据更新不及时问题； - ([6b2c911](https://github.com/xiyure/k-component-lib/commit/6b2c91154f8746d7fdfd15582eab86240e88269a))
- 1.代码逻辑优化：根据业务场景进行分离； - ([9533421](https://github.com/xiyure/k-component-lib/commit/9533421dd789a8652b6d8b69f3cb635a24f75ffa))
- 1.解决表格组件导出vxe-table方法时需要多嵌套一层问题；
2.冗余代码删除； - ([4c8557e](https://github.com/xiyure/k-component-lib/commit/4c8557e7c1a74fff205d9d8c1521a38cc45ee60b))
- 1.重写vxe-table部分原生方法以满足业务需求； - ([271fe0f](https://github.com/xiyure/k-component-lib/commit/271fe0f77035bd53475a667afb05f209cc927553))
- 1.项目工程优化，组件库打包时去除第三方依赖，防止版本冲突； - ([34206ba](https://github.com/xiyure/k-component-lib/commit/34206ba3f9e8a41f0d6b3a92bcd3c6a31d12603f))
...
- 1.撤销修改vxe-table原生方法文件； - ([b7fa3ba](https://github.com/xiyure/k-component-lib/commit/b7fa3bab2eb3aea166b6bdc26354c168f076ba45))
- 1.调整表格自定义图标时图标与文字之间的间距； - ([4359f8e](https://github.com/xiyure/k-component-lib/commit/4359f8ef4f2795f5b827076b1fa58b5d88ba0231))
- 1.表格初始化时高级筛选功能支持插入自定义条件； - ([802bb69](https://github.com/xiyure/k-component-lib/commit/802bb696901cf9b3b6418a1e2ff93605fc44af4c))
- 1.修改vxe-table中内置增删改查相关的原生方法；
2.解决页面数据统计不准确问题； - ([432813f](https://github.com/xiyure/k-component-lib/commit/432813f731cdce25f9eca0d1ed4cf9a7d4ffdd28))
- 1.css变量修改 - ([937491b](https://github.com/xiyure/k-component-lib/commit/937491b302d515bdf7944a16450849c17737827b))
...
- 1.表格组件新增isRemoteQuery和isRemotePaging参数； - ([20c4b7d](https://github.com/xiyure/k-component-lib/commit/20c4b7ddd4882c583002bc4e66b1d2afeedb1bdc))
- 1.tooltip、transfer、collapse组件样式调整； - ([afcf1d1](https://github.com/xiyure/k-component-lib/commit/afcf1d1fc3af967e8d991f5ae2b4416b03d0dd65))
...
- 1.filter组件添加自定义条件列表；
2.package.json依赖改用peerDependencies - ([56316f3](https://github.com/xiyure/k-component-lib/commit/56316f39ed086cfc2f49c831a0be4f3ab12363ab))
- 1.表格样式修改 - ([e5e4e6b](https://github.com/xiyure/k-component-lib/commit/e5e4e6b3bbbea49bd54df29fc67c735ace49d4c5))
...
- 1.解决表格组件表头控制器偶现操作无效问题； - ([0b6bc6c](https://github.com/xiyure/k-component-lib/commit/0b6bc6cd083d7a5318c97f2e0ac72bb1ee619187))
...
- 1.表格组件内置筛选和排序功能修改；
2.tree-table组件高级筛选新增exclude参数处理不参与高级筛选的列数据；
3.组件库事件总线调度器逻辑修改； - ([d752d14](https://github.com/xiyure/k-component-lib/commit/d752d14ff01ef0ecd90a6b2b6e4baab8c0448728))
...
- 1.table组件添加内置筛选模式 - ([42c69e4](https://github.com/xiyure/k-component-lib/commit/42c69e412ad535a3efe7db8b5ed072921cdb3ff8))
- 1.修复表格自定义单元格内容时内容布局与align属性不一致问题； - ([e180791](https://github.com/xiyure/k-component-lib/commit/e1807917af7d82c7a48da5d413dd40b17d1368fb))
...
- 1.组件方法导出处理； - ([f6dbc22](https://github.com/xiyure/k-component-lib/commit/f6dbc22ae2b26719b768403eaf19debca563496a))
- 1.部分组件方法导出处理 - ([b75e680](https://github.com/xiyure/k-component-lib/commit/b75e68005fba0fe9d1a98fc108e8629e3e588bf4))
- 1.添加组件expose配置文件；
2.处理部分组件方法导出； - ([92b06d5](https://github.com/xiyure/k-component-lib/commit/92b06d58d3e5894f40024b6bb2efc3bd64ef1477))
- 1.处理组件导出原生属性和方法；
2.公共库方法拓展：增加响应式数据判断； - ([736ebd2](https://github.com/xiyure/k-component-lib/commit/736ebd2426f1792cc5852db4392371b8fb698dba))
- 1.添加公共方法解析原生ElementPlus导出的属性；
2.vite配置文件修改； - ([3216f88](https://github.com/xiyure/k-component-lib/commit/3216f88b72c17049d7921760b0a4786c34883075))
- 1.表格组件树形数据设置节点展开最大值； - ([80aeb15](https://github.com/xiyure/k-component-lib/commit/80aeb15a19392ee58178832d9ea8765c0e00ae72))
- 1.优化树形表格节点折叠逻辑； - ([b496873](https://github.com/xiyure/k-component-lib/commit/b496873bbeab75c88b46e26af441ba70ee98c0f7))
- Tree-table head内容 宽度适配 - ([1007a5d](https://github.com/xiyure/k-component-lib/commit/1007a5d6da7d31d8090dd39c210efab2b448deb6))
- 1.tabs标签列表根据容器大小响应式更新；
2.冗余代码删除； - ([9edccd0](https://github.com/xiyure/k-component-lib/commit/9edccd0dde31024f795f2d0a9b1e38d9510d3cd6))
- Tab 下划线长度优化 - ([eadffb3](https://github.com/xiyure/k-component-lib/commit/eadffb3358ee8c014d535bf41e1abc125a9dacd9))
- 修改 button-group 相关样式 bug, 禁止失效 - ([2aa67fa](https://github.com/xiyure/k-component-lib/commit/2aa67fad9fb102e079cbff6e0c01a08f8602b82e))
- 1.表格组件添加搜索功能配置； - ([c6b2997](https://github.com/xiyure/k-component-lib/commit/c6b2997cb5f78c22e5eb2ebd23182ba9a67eb7f3))
- 1.优化表格搜索功能筛选效率；
2.表格高级筛选支持用户筛选可见数据/全部数据； - ([3056ca2](https://github.com/xiyure/k-component-lib/commit/3056ca23f7aa56c3f976a056e0fd734ff65ff927))
- 1.修复表格高级筛选条件偶现展示错误问题；
2.tab组件样式修改； - ([b1e8549](https://github.com/xiyure/k-component-lib/commit/b1e8549a97a1ce9bb421e12b36cc87b726d2f07f))
- 1.tab组件样式修改；
2.elementPlus版本升级； - ([9ad68da](https://github.com/xiyure/k-component-lib/commit/9ad68da7a5aeb601aafc20843ce3ab8362348530))
- 1.表格组件重写部分原生方法以满足现有业务场景；
2.参数类型添加； - ([2bec9fc](https://github.com/xiyure/k-component-lib/commit/2bec9fcd734598e1cbfe654f445938ce04fb7227))
- Css变量 - ([6b76a83](https://github.com/xiyure/k-component-lib/commit/6b76a838a61dd18fa925471093598a9eb4b8736e))
- 1.表格组件搜索功能支持筛选格式化后的数据；
2.KTag组件样式修改； - ([c11090e](https://github.com/xiyure/k-component-lib/commit/c11090e0878342f3715608384170b620d6eaf107))
- 1.自定义指令添加：文字提示；
2.tree-table组件按需引入图标 - ([4b8d8dc](https://github.com/xiyure/k-component-lib/commit/4b8d8dca3aedfeeee502b8af034f487b58968b48))
- 1.解决表格数据响应式丢失问题； - ([799a8ce](https://github.com/xiyure/k-component-lib/commit/799a8ced67bb936699c0385f7b2c7d224ba5f8b2))
- 1.tree-transfer组件树形数据性能优化；
2.表格工具栏添加hover提示；
3.calendar组件新增是否显示农历控制参数； - ([ec26d47](https://github.com/xiyure/k-component-lib/commit/ec26d477ecaf4250291de749f0587a86b4a9b0c0))
- 1.修复表格筛选树形结构时页面卡顿问题；
2.高级筛选功能优化； - ([47ed195](https://github.com/xiyure/k-component-lib/commit/47ed19585988dc17f899bc93b699b7472e97e5fd))
- 1.tree-table组件支持data参数以及loadData方法动态加载数据；
2.filter组件使用优化； - ([7de5c0e](https://github.com/xiyure/k-component-lib/commit/7de5c0e12d17835560254f95dba04103e634eafc))
- Tab 长度自适应 - ([56e58ac](https://github.com/xiyure/k-component-lib/commit/56e58ac7d6f09f4c1d301078f4a36ec1f7b09423))
- 1.tab代码结构优化； - ([5f207bb](https://github.com/xiyure/k-component-lib/commit/5f207bb43b5c1b6568e066d69ecff210bb470ad6))
- 1.修复form表单配合input组件使用时样式异常问题；
2.解决部分组价样式污染问题； - ([864be2b](https://github.com/xiyure/k-component-lib/commit/864be2b88a28c3b1221c5356f6e1d5337815e5d0))
- 1.filter组件拓展：高级筛选支持自定义规则；
2.k-tree-table组件优化对filter组件的支持，优化界面显示；
3.tab组件dom结构修改，兼容现有业务； - ([b97d15a](https://github.com/xiyure/k-component-lib/commit/b97d15a40c5cdb18011ce5a09815f71a6d39be25))
- 1.冗余代码删除；
2.tab组件类参数处理； - ([c5ed569](https://github.com/xiyure/k-component-lib/commit/c5ed569c18dadc79dd61d06f7b336f5bb39d22aa))
- 1.去除console.log语句 - ([d2afdcc](https://github.com/xiyure/k-component-lib/commit/d2afdccf07a087ea94fc5268ca453efd82e304fb))
- 1.表格组件兼容旧参数； - ([44299b5](https://github.com/xiyure/k-component-lib/commit/44299b593f4cd0a8e5c12d9fc34f1d9ee233a332))
- 1.k-tree-table组件表头工具栏重构：支持自定义功能和顺序；
2.修复表格分页配置修改后页面不更新问题；
3.样式修改； - ([605e677](https://github.com/xiyure/k-component-lib/commit/605e677bee5dc617b7d06ba11e6c1f32a772bdb1))
- 1.组件库支持导入Element原生组件，以K-组件名命名； - ([128d966](https://github.com/xiyure/k-component-lib/commit/128d966387475ea828be5220b2903fe8a816677e))
- 1.修复单元格存在图标时无法垂直居中问题； - ([24aa7d9](https://github.com/xiyure/k-component-lib/commit/24aa7d9acc637ac3eae27da41657041f2ed860ae))
- 1.表格批量统计时忽略禁用的行数据； - ([3b71574](https://github.com/xiyure/k-component-lib/commit/3b71574e4ffd0b1e20eb1df0dcc53d746b7c4c39))
- 1.tree-table和tree-transfer组件拖拽逻辑优化； - ([73efc0c](https://github.com/xiyure/k-component-lib/commit/73efc0c9c8012376e41301e175c1961bd8527bbd))
- 1.解决tabs组件tab溢出且使用插槽设置label时下拉框无法读取label文本问题；
2.组件库公共方法库拓展； - ([0080fc1](https://github.com/xiyure/k-component-lib/commit/0080fc19136395c83c0f9d5c6c86bef3fb911623))
- 1.新增KEmpty和KResult组件；
2.lint； - ([890666b](https://github.com/xiyure/k-component-lib/commit/890666b0a53a0c329dcb13bc85da17d8a25e6e9c))
- 1.组件库icon增加grayscale参数控制是否开启置灰状态； - ([1ce85e8](https://github.com/xiyure/k-component-lib/commit/1ce85e8bc1c9f0bfcc11bd288d9c617bd8e661a9))
- 1.组件库添加vxe-table全局配置; - ([0c23a2a](https://github.com/xiyure/k-component-lib/commit/0c23a2a9e2dff47de7de14443cf22c0cb8833a9f))
- 1.tree-table组件新增文本插槽，支持自定义图标外的文本部分； - ([d1a1500](https://github.com/xiyure/k-component-lib/commit/d1a15008fd7b55976263f96432c68abf334a3c24))
- 1.tooltip组件重构；
2.tag组件版本回退修改；
3.tab组件新增文本溢出下拉显示功能 - ([52c1937](https://github.com/xiyure/k-component-lib/commit/52c1937838ba9319138cd628ac958db914e0ce8f))
- Tabs 添加 maxWidth 属性 - ([10beb29](https://github.com/xiyure/k-component-lib/commit/10beb299deb517afb3f0a8e6b244a074246a7c58))
- 1.tab样式修改； - ([b6298a6](https://github.com/xiyure/k-component-lib/commit/b6298a6d8dc585f9e849dc8acedb4d1ece3641e2))
...
- 1.tabs组件溢出tab下拉个功能； - ([43fa67a](https://github.com/xiyure/k-component-lib/commit/43fa67a49fde0e8760f851502591bc833301f25b))
...
- 1.修改多层列头过高的问题;2.扩展了 tooltip 的插槽; - ([7610ef7](https://github.com/xiyure/k-component-lib/commit/7610ef725846f8d00d6098ea454902fba45afd0b))
- 1.解决vxe-table鼠标悬浮时tooltip显示异常问题； - ([0fc8462](https://github.com/xiyure/k-component-lib/commit/0fc846225d9d3f648d5231b85a55553be03b7339))
- 1.operate组件参数拓展； - ([66cb345](https://github.com/xiyure/k-component-lib/commit/66cb345e101bbdd73861e201558ad0af89d02358))
...
- 1.tree-transfer组件性能优化；
2.operate组件添加禁用参数； - ([9441eea](https://github.com/xiyure/k-component-lib/commit/9441eea0295160f081bcf80e133ffd2ca4a9e71a))
- Tag, 添加 text 属性 - ([c2c88dd](https://github.com/xiyure/k-component-lib/commit/c2c88dd5b1733a0193417c4432416399cc40d75b))
- Tree_select 代码格式化 - ([07e0eed](https://github.com/xiyure/k-component-lib/commit/07e0eedb9c1a7171054b6b9bc61e2010180c526b))
- 修改 tree_select 文件夹没有 children 时, icon 变黄 - ([4c84432](https://github.com/xiyure/k-component-lib/commit/4c844321ac255ed3966608663cea4a0bdf39c2c2))
- 1.icon名兼容新版本vxe-table； - ([e823309](https://github.com/xiyure/k-component-lib/commit/e823309a9ab5157db5442521e26eddc958023b70))
- 1.组件样式修改；
2.lint； - ([1f56f9d](https://github.com/xiyure/k-component-lib/commit/1f56f9dd74ef0a6719f3038c8f17d1a0cc7c31ba))
- 1.表格组件性能优化，通过计算属性进行数据处理减少渲染次数，提升性能 - ([3ef761b](https://github.com/xiyure/k-component-lib/commit/3ef761bd013e1aaa6afead32088044a64f372fbf))
- 1.修复表格数据不显示问题； - ([b7e856b](https://github.com/xiyure/k-component-lib/commit/b7e856bd85560b7f25de930fe0ce768383e7521c))
- 1.tree-table方法拓展 - ([e1d4b95](https://github.com/xiyure/k-component-lib/commit/e1d4b956406ba33398a974b0cf5cd4e51830560c))
- 1.vxe-table版本升级；
2.修复表格偶现高亮切换异常问题；
3.修复高级筛选组件偶现控制台报错和卡死问题； - ([19425de](https://github.com/xiyure/k-component-lib/commit/19425deb0b21de7804e856cee0a327f6b04c93bd))
- 1.修复filter组件清除筛选条件时报错问题；
2.修复树形表格使用filter组件时偶现死循环问题；
3.表格组件各层数据解耦，防止未知操作造成的数据异常； - ([9660989](https://github.com/xiyure/k-component-lib/commit/9660989460ac4b1f9599c05c4795845358d38d2c))
...
- 1.冗余代码删除 - ([d07f5d9](https://github.com/xiyure/k-component-lib/commit/d07f5d99d289c30395c2b25258fc44fb28c5a01e))
- 1.KButton组件兼容element-ui原生属性； - ([2112e36](https://github.com/xiyure/k-component-lib/commit/2112e365132d619f7f68ce0d5546964c7b115e7e))
- 1.fix：修复表格单元格高亮偶现异常问题； - ([709bf3e](https://github.com/xiyure/k-component-lib/commit/709bf3e2e60e16503ebdf02fe2b532904effe295))
- 1.修复树形穿梭框更改默认值时数据异常问题； - ([a253053](https://github.com/xiyure/k-component-lib/commit/a253053460c8770551fecc5a3f6acf3debf4aa5f))
- 1.tree-table组件表格列使用图标时支持对文本内容的格式化； - ([98203cc](https://github.com/xiyure/k-component-lib/commit/98203cc6c3c8d3f6da85b8361b947d651b605100))
...
- 1.修复tree-transfer组件长文本溢出问题； - ([83c4d4e](https://github.com/xiyure/k-component-lib/commit/83c4d4e25396f7933eb72c02f3d85cd87236835d))
- 1.table-column组件兼容vxe-column原生属性;
2.修复单元格添加图标后无法垂直居中问题；
3.tree-table组件新增cellClickToggleHighlight参数控制是否单击取消高亮行功能； - ([0239686](https://github.com/xiyure/k-component-lib/commit/0239686b1aafe1bfc52ce854ce24e1ca5ef547f7))
- Select, size:sm - ([c8252cd](https://github.com/xiyure/k-component-lib/commit/c8252cd0d886cf96b40d88e9a6e0c53669b273fe))
- 1.修复表格单元格内容包含图标时无法垂直居中问题； - ([4d4f581](https://github.com/xiyure/k-component-lib/commit/4d4f581546ecf75224a389f63ae2ec48b80452db))
- 1.高级筛选兼容树形数据结构处理；
2.修复表格size与ui的不一致问题；
3.tree组件dom结构调整； - ([527c21f](https://github.com/xiyure/k-component-lib/commit/527c21f00d0c7d67035ac95b571dc09d0fffc634))
...
- 1.多级表头支持穿梭框拖拽功能；
2.lint - ([2d9f481](https://github.com/xiyure/k-component-lib/commit/2d9f481e54ef797dce09833db15f0eb9790c24aa))
...
- 移除.prettierrc.js - ([b4ab51c](https://github.com/xiyure/k-component-lib/commit/b4ab51c32dbd3474d7940a14c6cfb6732864e479))
- 移除RouterLink, RouterView - ([e868341](https://github.com/xiyure/k-component-lib/commit/e8683416f0f23196efb10757c9ad5085cdbea28f))
...
- 1.修复表格组件列配置变化时列渲染顺序混乱问题； - ([be2bbac](https://github.com/xiyure/k-component-lib/commit/be2bbac4b9704be8a975f28d049a3f67352e5f93))
...
- 1.多级表头兼容render函数、高级筛选等功能；
2.修复列数据改变时穿梭框数据展示异常问题； - ([a6077a9](https://github.com/xiyure/k-component-lib/commit/a6077a9f35ad229ca87c8d84ae8a4d6cbe88d3cb))
- 冗余公共样式; change: input 插槽 - ([8d5329e](https://github.com/xiyure/k-component-lib/commit/8d5329ed127912649a1a700cc6cf61d9c698e85a))
- 1.解决表格组件偶先渲染混乱问题； - ([c8f207b](https://github.com/xiyure/k-component-lib/commit/c8f207b41cc03d8cf3b03233961450a140caf902))
- Prettierrc 格式化插件 - ([6f29432](https://github.com/xiyure/k-component-lib/commit/6f2943201c2eef09ffc951b9e71d6dac825fbc26))
- 1.修复表格组件多级表头时field插槽不生效问题；
2.tree-transfer组件初始化渲染顺序根据传入的默认值渲染； - ([c8f6283](https://github.com/xiyure/k-component-lib/commit/c8f62832abd08adec5f39e6aa9a4514b9bf2c212))
...
- 1.表格组件支持自定义表头； - ([7297d66](https://github.com/xiyure/k-component-lib/commit/7297d66b6085eb7e1c3bd6dc4e0102ace50a0bdc))
- Tabs closable 按钮样式偏移 - ([b9b43e0](https://github.com/xiyure/k-component-lib/commit/b9b43e08f2ac37fcc4c31c15659ce1d2d92c628a))
- 冗余文件去除； - ([94769a1](https://github.com/xiyure/k-component-lib/commit/94769a182712b3cdd6f72486cb4b0e4f0241b9aa))
...
- 1.tree-table组件设置use-tree参数时移除数据统计模块；
2.KTabItem组件更名为KTabPane； - ([9fe9dd3](https://github.com/xiyure/k-component-lib/commit/9fe9dd3f859be88562b126ad274da53368f3c835))
- 1.表格组件新增showColumnMenu参数；
2.修复表格内容无法垂直居中问题；
3.表格支持单元格自定义样式； - ([4f0c7c1](https://github.com/xiyure/k-component-lib/commit/4f0c7c1fd825584ac3b57ea35c5f19e09630e7dc))
- 1.tree-transfer组件拖拽优化；
2.table组件默认不展示功能菜单； - ([083b3aa](https://github.com/xiyure/k-component-lib/commit/083b3aac00a28886589016e814be5383b3d9a4fa))
- 优化 button icon style - ([5ac4b98](https://github.com/xiyure/k-component-lib/commit/5ac4b981a373419ebfb2c49850add4055239d17c))
- 1.table组件样式修改; - ([a1dc0f1](https://github.com/xiyure/k-component-lib/commit/a1dc0f16285587fd3732089cf975584b4ecbc1e5))
- 更新 radio button 的样式 - ([a3623b3](https://github.com/xiyure/k-component-lib/commit/a3623b3aacb140770e8e895acb8723a392aeaf27))
- 1.checkbox组件添加strict参数；
2.样式修改； - ([d34d573](https://github.com/xiyure/k-component-lib/commit/d34d57362274e3afc3c4b320f6107822f3041f42))
- 修改 bug : tree 背景黑色 - ([e44d852](https://github.com/xiyure/k-component-lib/commit/e44d8521952ba32be4412695d70dbf6721809690))
- 1.新增operate组件关闭事件触发时关联表格；
2.fix：修复表格组件存在多级表头时渲染异常问题；
3.部分组件样式调整； - ([e6cf0e5](https://github.com/xiyure/k-component-lib/commit/e6cf0e5f800efe3e97c16ed801aebfa749ffe2ed))
- Button disable 点击事件 - ([0a5bf04](https://github.com/xiyure/k-component-lib/commit/0a5bf048676deb2be12a56b90b6018b219f33974))
- 1.去除控制台警告； - ([7c8c48c](https://github.com/xiyure/k-component-lib/commit/7c8c48ca09f619a94d1cb77983c974acb0f417d9))
- 1.表格支持多级表头； - ([a607953](https://github.com/xiyure/k-component-lib/commit/a6079538d6f4c80d7ffa6e7386eec98dcdb3f2b7))
...
- 修正 select display 属性,  input cursor 属性 - ([9750242](https://github.com/xiyure/k-component-lib/commit/9750242a97a4017090ca971bf28e303354ec30cb))
- 1.修复tree-table组件show-transfer为true时出现意外警告问题； - ([f443709](https://github.com/xiyure/k-component-lib/commit/f443709167ab8a59d3e96e35184848359ad566a9))
- 修改 input, select 样式, 添加组件 inputGroup - ([29f16e8](https://github.com/xiyure/k-component-lib/commit/29f16e8c50d791c99df687c4ca6b0d6c55e2942b))
- 1.package.json文件修改 - ([1e094f7](https://github.com/xiyure/k-component-lib/commit/1e094f78cc334c8d22e71f23ded901d7dd03f6db))
- 1.表格组件集成批量操作功能；
2.修复tab组件切换异常问题；
3.添加dom拖拽自定义指令； - ([44a98a7](https://github.com/xiyure/k-component-lib/commit/44a98a7cf078de88422611b7492f458fb9bc8db1))
- 新组件 inputGroup - ([ec2368d](https://github.com/xiyure/k-component-lib/commit/ec2368dc8f0066bb2e14eb5df002ef21881d3b19))
- 1.gitignore文件修改; - ([a3c8938](https://github.com/xiyure/k-component-lib/commit/a3c8938c7ce11e9d733f5f0e98c3a1eee1373207))
- 1.修复表格组件高度计算错误问题；
2.tree-transfer组件插槽拓展 - ([77e1a54](https://github.com/xiyure/k-component-lib/commit/77e1a54327e076df478eed50335a6b1bafe647cd))
- 1.tree-transfer组件icon、expandIcon和collapseIcon参数支持函数传参；
2.表格组件新增取消高亮事件；
3.表格复选框disabled样式修改；
4.dropdown组件代码结构优化； - ([08f5eae](https://github.com/xiyure/k-component-lib/commit/08f5eae9b6b628734619d53c2f7b1bc29a196ec7))
- 修改 tabs 中的 样式污染 - ([f42e238](https://github.com/xiyure/k-component-lib/commit/f42e2389ad46afefb6909af826b5ac45a018a8be))
- 禁止追踪 pnpm-lock - ([fc74721](https://github.com/xiyure/k-component-lib/commit/fc7472148abf27c2320ad2567f27017fd1c25912))
- 1.calendar组件任务列表展示页面修改;
2.ES-lint - ([f1b45c1](https://github.com/xiyure/k-component-lib/commit/f1b45c12d1f206f910b4129a8c2532cbc8736147))
-  add:公共样式中添加.init-style, 并且初始化 button, radio 的样式 - ([255f868](https://github.com/xiyure/k-component-lib/commit/255f868350545083b1e4aebfc23508f9f5b402e7))
...
-  change: 添加并修改了公共样式 css; 重构了 radio & radio-group 的样式 - ([32b0ee6](https://github.com/xiyure/k-component-lib/commit/32b0ee628b6bf4ebbbf914adf593d45d4c1ac769))
-  change:  eslint对模板字符串中空格校验规则 - ([08e5e8d](https://github.com/xiyure/k-component-lib/commit/08e5e8dae3625e9cbc1b764831240a2acde0e262))
-  change: button font 属性 - ([1f3454b](https://github.com/xiyure/k-component-lib/commit/1f3454b3164bead21bd0a41ae7100edfcab7432b))
- Button radio 公共样式 - ([3e2aff4](https://github.com/xiyure/k-component-lib/commit/3e2aff4f6652ffb229abaf121684888d1aa73732))
- 1.tree-table组件新增行拖拽功能； - ([5443fdf](https://github.com/xiyure/k-component-lib/commit/5443fdf5f7a3feb3b8d1fd1332568494b1aa290f))
- 1.tree-table组件参数拓展：单元格图标添加内置状态； - ([697be3c](https://github.com/xiyure/k-component-lib/commit/697be3cb20a5a4ad380944689cc42e89334e0036))
- 1.部分使用KButton的组件适配新button组件； - ([4ce7503](https://github.com/xiyure/k-component-lib/commit/4ce7503ca3747788cd52a073f1d330862f164cc1))
- 1.button组件代码格式优化 - ([3dcd6bb](https://github.com/xiyure/k-component-lib/commit/3dcd6bba8cc93009be6bfdd8be4ba10e5c90aa5c))
- 1.全局事件管理器优化；
2.tree-table组件新增单击高亮行取消高亮功能；
3.lint - ([25c76c1](https://github.com/xiyure/k-component-lib/commit/25c76c1292fdce26ac7decebeb7f6bf4af54f72f))
...
-  delete: utils > GetColorLevel 中的无效代码 - ([4840f7a](https://github.com/xiyure/k-component-lib/commit/4840f7ad9351acfec090da404dbec893d54b3931))
- 1.tree-transfer组件添加drag参数；
2.代码结构调整 - ([3ae8bdd](https://github.com/xiyure/k-component-lib/commit/3ae8bdda66b798e469f1bbc438f088f951647f87))
- 1.step组件插槽拓展；
2.tree-transfer组件样式调整;
3.tree-table组件插槽拓展 - ([d6dfb9c](https://github.com/xiyure/k-component-lib/commit/d6dfb9c8c631dbe40da9d387ba8b3e9abdfaa87c))
-  delete: button 中的 log 打印 - ([8455231](https://github.com/xiyure/k-component-lib/commit/84552316d05c3b2adad3945632f9bbd3328734be))
...
-  change: button - ([bdb0751](https://github.com/xiyure/k-component-lib/commit/bdb07516b2b749ca208c282dfd5f1a387e69267e))
- 1.解决页面存在多个tree-transfer组件时组件卡死问题; - ([9752d58](https://github.com/xiyure/k-component-lib/commit/9752d580b10c148d9f5fb3d9cf472b64e32ca606))
- 1.step组件添加内置类型；
2.tree-transfer和tree-table组件样式调整； - ([9e4bf59](https://github.com/xiyure/k-component-lib/commit/9e4bf598e431dca02da2e0f71978e85242e454c3))
- 1.表格增加自定义图标 - ([f2733cd](https://github.com/xiyure/k-component-lib/commit/f2733cd7530e5bb2360f610f34b0da21d1646f82))
- 1.tree-transfer组件参数拓展，支持自定义图标及填充； - ([052d452](https://github.com/xiyure/k-component-lib/commit/052d45228e1d9d713ad29586636088b531951d86))
- 1.修复tree-table组件数据不更新问题；
2.table组件结构调整； - ([5227f7e](https://github.com/xiyure/k-component-lib/commit/5227f7e66c34dfe4bd8aa086b3aaeb76e518b7f8))
- 1.修复filter组件size=sm时样式异常问题；
2.修复tree-table组件无法自适应父组件问题； - ([f3d75e8](https://github.com/xiyure/k-component-lib/commit/f3d75e88db6a058a9701ee626b9065ab61804c18))
- 1.修改tag组件内置样式以及颜色填充规则；
2.filter和tree-table组件增加size样式；
3.elementPlus版本升级； - ([981acb1](https://github.com/xiyure/k-component-lib/commit/981acb1c5288d2eea95961e6426c2194c6d6cdcc))
- 1.package.json文件更新 - ([20d036d](https://github.com/xiyure/k-component-lib/commit/20d036dd0cbb35d4f8b274b18e8e87c0edf9bc21))
- 1.修复内置日期切换时时间不更新问题 - ([30e69a9](https://github.com/xiyure/k-component-lib/commit/30e69a94ffd22a7bc6d8492ba3524991a13907ae))
- 1.table组件样式调整 - ([f22c430](https://github.com/xiyure/k-component-lib/commit/f22c430b92a91890b4c153f6f5ae5daf01e8aa52))
- 1.tag组件添加内置样式 - ([05734d7](https://github.com/xiyure/k-component-lib/commit/05734d7be16df7d29db0aa78d78c12c3c7aad0f1))
- 1.变量名称修正； - ([082a99d](https://github.com/xiyure/k-component-lib/commit/082a99dd789e9c22e8338ac65b3b8d30b1dcb641))
- 1.filter组件数据类型为string去除大于小于逻辑选项；
2.datePicker组件添加内置时间选项；
3.tree-transfer组价列表高度与父元素保持一致； - ([952dbe7](https://github.com/xiyure/k-component-lib/commit/952dbe7072c354634db0f2bb606549c698a69063))
- 1.修复tree-transfer组件筛选状态下数据异常问题； - ([ce06647](https://github.com/xiyure/k-component-lib/commit/ce06647be277f6aece1491b59a846f64a9e1603b))
- 1.tree-transfer组件完善
2.filter组件添加图标状态 - ([c8a45e8](https://github.com/xiyure/k-component-lib/commit/c8a45e8190593f26ef0a1987eef1d0d24d3934e0))
- 1.修复filter组件日期选择报错问题 - ([3a1f424](https://github.com/xiyure/k-component-lib/commit/3a1f424e1a31c02cb9f7205f4cf6c13b8cd6fb91))
- 1.新增tree-transer组件
2.修复树形表格搜索死循环问题 - ([e3fd8b4](https://github.com/xiyure/k-component-lib/commit/e3fd8b416be86923ba24bb4ef1dc0162af048494))
- 1.修复tree-table组件表头居中和分页异常问题； - ([03954bf](https://github.com/xiyure/k-component-lib/commit/03954bfa7d014a199e26ef53b14e5d80aabf5932))
- Button 中的打印 - ([0da7cdf](https://github.com/xiyure/k-component-lib/commit/0da7cdf2cac265552efa6314f0c4cee47bbb8025))
- 1.filter组件新增border参数
2.tree-table组件参数修正 - ([c135163](https://github.com/xiyure/k-component-lib/commit/c1351632266b8dc38417e6d52b8a5141061e14ab))
- 1.解决表格组件自定义渲染时死循环问题 - ([cbce86c](https://github.com/xiyure/k-component-lib/commit/cbce86cac79236c170f48ef145b0f980da2a9f66))
...
- 1.部分组件代码逻辑优化 - ([fdaf571](https://github.com/xiyure/k-component-lib/commit/fdaf571e9b6d6d2e73d6513f3cec4b51c26fffee))
- 1.版本号修改 - ([bfd36e5](https://github.com/xiyure/k-component-lib/commit/bfd36e5ca8c9d84dc5bcc6e5b90866c4db9637a4))
- 1.冗余代码删除 - ([e1ed082](https://github.com/xiyure/k-component-lib/commit/e1ed0823b96b7b194cfdd2d30fedf16deea80f38))
- 1.去除冗余依赖 - ([a4ab104](https://github.com/xiyure/k-component-lib/commit/a4ab104b06561cb2aa9c0376c7f20f772c374bd3))
- 1.transfer组件新增拖拽排序功能;
2.tree-table组件新增表头交换功能 - ([8bb4bac](https://github.com/xiyure/k-component-lib/commit/8bb4bace09c2e9d7fa2694f2aa68901ad7648d25))
- 1.filter组件重构；
2.tree-table组件添加高级筛选、穿梭框以及数据信息展示；
3.table组件新增菜单是否显示参数 - ([a0eb58b](https://github.com/xiyure/k-component-lib/commit/a0eb58b7219a4da57fcacdbe75fd961ef52ace1b))
- 1.修复dropdown组件下拉框异常问题;
2.tree组件搜索框优化； - ([c6d2592](https://github.com/xiyure/k-component-lib/commit/c6d2592745559c25c89554fea679ca17c7c568bf))
- 1.组件库兼容Element所有参数 - ([b28760b](https://github.com/xiyure/k-component-lib/commit/b28760b0ff78284bddae6d25575499a69dba7231))
- 1.form组件快捷键修改 - ([a116bde](https://github.com/xiyure/k-component-lib/commit/a116bde9288a14345d5574aebe950de4253aa535))
- 1.tab组件修改 - ([db4cd8c](https://github.com/xiyure/k-component-lib/commit/db4cd8c54fea20da942f5ab1419411805564174f))
- 按钮样式 - ([784d862](https://github.com/xiyure/k-component-lib/commit/784d862eaa02cf17faae6b8a60c7bd6372908353))
- 1. tab组件拓展
2.form快捷键优化
3.filter组件点击查询时参数添加匹配规则 - ([1d52a67](https://github.com/xiyure/k-component-lib/commit/1d52a676d126189c9e1951fdfe5e6b46060b94ec))
...
- 1.树表组件拓展 - ([495a465](https://github.com/xiyure/k-component-lib/commit/495a465aa7f80d4cbeb51c05d804f3a71fc0ee95))
...
- 1.tree-table性能优化 - ([1436040](https://github.com/xiyure/k-component-lib/commit/1436040362e6923807fac9831828e75ab384af73))
- 1.form组件快捷键优化 - ([c337b73](https://github.com/xiyure/k-component-lib/commit/c337b73dea24b1d2f71102e8cb8b1814a7d5612a))
- 1.新增dropdown组件；2.form组件用户体验优化，支持回车聚焦下一个输入框；3.table组件样式调整； - ([2ba59bb](https://github.com/xiyure/k-component-lib/commit/2ba59bba05ff6847a4856a8b8814e9ef3d11ba00))
- Tree-table组件筛选逻辑优化 - ([1ff83db](https://github.com/xiyure/k-component-lib/commit/1ff83db4c4bc0b5b601b42dd6f02e6744ae5af44))
- 1.radio组件支持自定义颜色；2.checkbox颜色填充逻辑优化；3.代码格式化； - ([1189275](https://github.com/xiyure/k-component-lib/commit/1189275a3f1d0e388514878865884a345c657e90))
- Story单号：.NA
提交人：周韩杰
提交说明：1.tree-table和table组件事件添加；2.删除字体文件； - ([b52963a](https://github.com/xiyure/k-component-lib/commit/b52963a23d68b4cfa346425c972ff2e5962b4c7c))
- Story单号：.NA
提交人：周韩杰
提交说明：1.table组件支持导出vxe-table实例方法；2.checkbox样式污染问题解决；3.switch组件参数调整； - ([da31777](https://github.com/xiyure/k-component-lib/commit/da31777358b0c19585d2105f87d28597d45e8aa8))
- Story单号：.NA
提交人：周韩杰
提交说明：1.修复部分基础组件外部方法无返回值问题； - ([62b77be](https://github.com/xiyure/k-component-lib/commit/62b77be055f5ec4388028695e7bae302a3065f6f))
- Story单号：.NA
提交人：周韩杰
提交说明：1.input组件参数拓展； - ([f654d1a](https://github.com/xiyure/k-component-lib/commit/f654d1ac1249ec05173a98e263c34d35a0d010e9))
- Story单号：.NA
提交人：周韩杰
提交说明：1.tree-table组件拓展数据监控和页码状态更新功能；2.checkbox组件支持自定义复选框颜色 - ([a7ba519](https://github.com/xiyure/k-component-lib/commit/a7ba5191b5077118dd059c674740a31a1c4a18ce))
- Story单号：.NA
提交人：周韩杰
提交说明：1.部分组件页面结构修改； - ([f4519a9](https://github.com/xiyure/k-component-lib/commit/f4519a9f3d9b7c8af815ec03fb132d135907eda5))
- Story单号：.NA
提交人：周韩杰
提交说明：1.tree-table组件问题修复；2.button组件样式修改； - ([9d077f9](https://github.com/xiyure/k-component-lib/commit/9d077f9e536fb68dc353d62cca6f5a34099a8fad))
- Story单号：.NA
提交人：周韩杰
提交说明：1.tree-table组件功能拓展，支持树表结构的排序和筛选； - ([d804fc4](https://github.com/xiyure/k-component-lib/commit/d804fc44a2ad9b00a65d549df86f669efed2378b))
- Story单号：.NA
提交人：周韩杰
提交说明：1.新增tree-table组件；2.table组件问题修复； - ([9935f0c](https://github.com/xiyure/k-component-lib/commit/9935f0cf1edd0141c0ca8b225aacef9445f76501))
...
- Story单号：.NA
提交人：周韩杰
提交说明：1.分页组件参数拓展（基于Element）； - ([074d540](https://github.com/xiyure/k-component-lib/commit/074d5407c1c3a4f8c087b6cc3e4687f3539b7f63))
...
- Story单号：.NA
提交人：周韩杰
提交说明：1.类型文件调整； - ([cccbaa6](https://github.com/xiyure/k-component-lib/commit/cccbaa6811e38624a50f391df1bb20e79fd750e0))
- Story单号：.NA
提交人：周韩杰
提交说明：1.部分组件页面结构调整； - ([905c23a](https://github.com/xiyure/k-component-lib/commit/905c23a830e6d00a0f30e0dba324440149cad2a0))
- Story单号：.NA
提交人：周韩杰
提交说明：1.tour组件初版上传；2.公共函数提取； - ([0fc185f](https://github.com/xiyure/k-component-lib/commit/0fc185f2ba7861665bece4cce074f7057fb7c4e6))
- Story单号：.NA
提交人：周韩杰
提交说明：1.新增tree组件； - ([2e74395](https://github.com/xiyure/k-component-lib/commit/2e743950b913da346c8efa79e587d047988a6d37))
- Story单号：.NA
提交人：周韩杰
提交说明：1.新增calendar组件；2.timeline组件支持自定义颜色的空心样式；3.修改button组件text状态下的背景色； - ([2d52717](https://github.com/xiyure/k-component-lib/commit/2d52717e335212ca8c2b08301afd3dfe1e9d5f42))
- Story单号：.NA
提交人：周韩杰
提交说明：1.新增timeline组件； - ([50b6074](https://github.com/xiyure/k-component-lib/commit/50b607412e128a70fad376d17b41906a25c42c8c))
- Story单号：.NA
提交人：周韩杰
提交说明：1.view组件新增列表拖拽排序功能；2.tag组件point模式时添加默认填充；3.view组件列表展示优化； - ([e4459a8](https://github.com/xiyure/k-component-lib/commit/e4459a8dc092e8fa8ec8a8e4a53975742b7cd201))
- Story单号：.NA
提交人：周韩杰
提交说明：1.新增badge组件；2.修复filter组件日期选择时数据异常问题；3.select组件参数扩展； - ([3b140a1](https://github.com/xiyure/k-component-lib/commit/3b140a1f6bcd8060ae9ccdda834c5627fd3d33b4))
- Story单号：.NA
提交人：周韩杰
提交说明：1.组件库国际化 - ([ea44a90](https://github.com/xiyure/k-component-lib/commit/ea44a903b04caf96b9374a09d41c7959d0122d29))
- Story单号：.NA
提交人：周韩杰
提交说明：1.新增view组件；3.loading组件初版上传(暂不支持template中使用)；3.移除filter组件保存视图功能； - ([a7c08d6](https://github.com/xiyure/k-component-lib/commit/a7c08d6d1c2c3cd7f56b97f7c16474e0a37eb9df))
- Story单号：.NA
提交人：周韩杰
提交说明：1.新增collapse组件； - ([57ba5f2](https://github.com/xiyure/k-component-lib/commit/57ba5f24487e1fe4fde442cbf8667f315c7ca45e))
- Story单号：.NA
提交人：周韩杰
提交说明：1.修复tab组件路由模式异常问题；2.filter组件新增保存视图功能和条件选项；3.去除冗余依赖； - ([81f554f](https://github.com/xiyure/k-component-lib/commit/81f554fb620f64699b92e44b77bd86d5a9c82ad4))
- Story单号：.NA
提交人：周韩杰
提交说明：1.修复uplaod组件在drag模式下无法拖拽文件问题；2.修复tableColumn组件无法继承父组件table属性问题； - ([1365e26](https://github.com/xiyure/k-component-lib/commit/1365e2686d656fb5342fb2aa67d8b8e87003f005))
- Story单号：.NA
提交人：周韩杰
提交说明：1.新增step组件；2.修复dialog组件和drawer组件设置close-after属性失效问题； - ([fda0e6f](https://github.com/xiyure/k-component-lib/commit/fda0e6f72345ad40b7502449ef67dbdc1f8b7cc0))
- Story单号：.NA
提交人：周韩杰
提交说明：1.新增form组件；2.ElementPlus版本更新；3.代码结构优化； - ([dfebcae](https://github.com/xiyure/k-component-lib/commit/dfebcaeec9bc7bf5726c5dbb0468fdc5394b0a03))
- Story单号：.NA
提交人：周韩杰
提交说明：1.新增drawer组件；2.table组件图标更换；3.代码结构优化； - ([b143186](https://github.com/xiyure/k-component-lib/commit/b1431865cf4ba7209a033f5f31d72d3e58260fda))
- Story单号：.NA
提交人：周韩杰
提交说明：1.新增table组件；2.checkbox组件checked参数添加；3.新增Emitter类管理事件； - ([60a0008](https://github.com/xiyure/k-component-lib/commit/60a0008de634b5190fd444d351a6a15d78baeaa0))
- Story单号：.NA
提交人：周韩杰
提交说明：1.组件库打包配置优化 - ([f147095](https://github.com/xiyure/k-component-lib/commit/f147095de2cb7e86cd078a12788f142d736d6a43))
- Story单号：.NA
提交人：周韩杰
提交说明：1.组件库打包时生成类型声明文件 - ([dbcaa67](https://github.com/xiyure/k-component-lib/commit/dbcaa67bf2d6030a6054e4eb5c219ab44aa3df2e))
- Story单号：.NA
提交人：周韩杰
提交说明：1.组件库打包功能开发；2.更新图标库；3.部分组件字段名修改； - ([84ff112](https://github.com/xiyure/k-component-lib/commit/84ff1121fc44967ecfb45102fdff8e63bb4878f8))
- Story单号：.NA
提交人：周韩杰
提交说明：1.新增filter组件；2.select、input组件结构优化；3.部分组件样式调整； - ([313bb20](https://github.com/xiyure/k-component-lib/commit/313bb2030979cd9117e47a9e8c41df5bc6bd6e4d))
- Story单号：.NA
提交人：周韩杰
提交说明：1.新增tooltip组件； - ([077e98c](https://github.com/xiyure/k-component-lib/commit/077e98c6005133317d4a82f9be8a7ffaffc4d48a))
- Story单号：.NA
提交人：周韩杰
提交说明：1.新增dialog组件； - ([f2bb033](https://github.com/xiyure/k-component-lib/commit/f2bb0339798eda3fce17ee65efc6263eddaf8457))
- Story单号：.NA
提交人：周韩杰
提交说明：1.新增message组件； - ([6415f88](https://github.com/xiyure/k-component-lib/commit/6415f888286950ae8e3aa96f09ddd2274b7128c9))
- Story单号：.NA
提交人：周韩杰
提交说明：1.新增status组件； - ([28f1e31](https://github.com/xiyure/k-component-lib/commit/28f1e3187f3732bffbc229e59833d066f41014f2))
- Story单号：.NA
提交人：周韩杰
提交说明：1.新增popconfirm组件； - ([9877db2](https://github.com/xiyure/k-component-lib/commit/9877db2592484e2bc863ec1e8af9c9b44a4773a9))
- Story单号：.NA
提交人：周韩杰
提交说明：1.项目引入全局less变量以及阿里普惠字体；2.部分组件样式调整; - ([aaffdec](https://github.com/xiyure/k-component-lib/commit/aaffdec0c44fda51152ece7a92915485743c991a))
- Story单号：.NA
提交人：周韩杰
提交说明：1.新增popover组件；2.采用defineOptions API重写组件配置; - ([5d09929](https://github.com/xiyure/k-component-lib/commit/5d09929c427f2f0ea3caf0216232c14ce557b7ae))
- Story单号：.NA
提交人：周韩杰
提交说明：1.新增tag组件；2.部分组件命名格式修改; - ([7ef03b5](https://github.com/xiyure/k-component-lib/commit/7ef03b540224062e64ab43d989a37b5725c3d696))
- Story单号：.NA
提交人：周韩杰
提交说明：1.新增operate组件；2.tansfer组件新增恢复默认功能；3.部分组件样式优化；； - ([dbe4b28](https://github.com/xiyure/k-component-lib/commit/dbe4b28f4cab41deae163788791b4241178b183c))
- Story单号：.NA
提交人：周韩杰
提交说明：1.upload组件点击事件异常处理；2.upload图标更换；3.项目配置项修改； - ([728d328](https://github.com/xiyure/k-component-lib/commit/728d3287de81538104c6379bde04e422a3f19198))
- Story单号：.NA
提交人：周韩杰
提交说明：1.新增transfer组件；2.组件库集成ksw-icon图标库；3.组件按需配置优化； - ([53f1054](https://github.com/xiyure/k-component-lib/commit/53f1054cea61c554c303d8369a4fbf45da98a40a))
- Story单号：.NA
提交人：周韩杰
提交说明：1.checkbox组件文件名称修改； - ([c85d6c3](https://github.com/xiyure/k-component-lib/commit/c85d6c3470e9195bf580b2f9f4f9847c6a3d9208))
- Story单号：.NA
提交人：周韩杰
提交说明：1.新增upload组件；2.icon图标集成；3.button组件、checkbox组件问题修改； - ([caa0782](https://github.com/xiyure/k-component-lib/commit/caa07826afec56bbc638c3bb6410a8912712dea8))
- Story单号：.NA
提交人：周韩杰
提交说明：1.新增dataPicker组件； - ([10bc55d](https://github.com/xiyure/k-component-lib/commit/10bc55d21c13f7fa391a98b34b86ccda33d048c7))
- Story单号：.NA
提交人：周韩杰
提交说明：1.组件样式文件重构，以less文件代替css文件； - ([17b8fab](https://github.com/xiyure/k-component-lib/commit/17b8fab395ad2a605546ff72bc4c31456535e944))
- Story单号：.NA
提交人：周韩杰
提交说明：1.新增cascader组件；2.修复部分组件间css样式污染问题； - ([5be1bae](https://github.com/xiyure/k-component-lib/commit/5be1bae8bfa306a0b6cd8a603155336caace4b29))
- Story单号：.NA
提交人：周韩杰
提交说明：1.新增select组件；2.checkbox组件样式调整；3.添加eslint校验规则； - ([d45646b](https://github.com/xiyure/k-component-lib/commit/d45646b17608fdcba99a286f4674082c8dde2b55))
- Story单号：.NA
提交人：周韩杰
提交说明：1.checkbox组件新增自定义填充颜色选项； - ([a7ae0b9](https://github.com/xiyure/k-component-lib/commit/a7ae0b9f5d8429afb408451d71e51bf077f904ac))
- Story单号：.NA
提交人：周韩杰
提交说明：1.新增checkbox组件；2.interface文件调整； - ([82c6c78](https://github.com/xiyure/k-component-lib/commit/82c6c7850a5164c146a1a08a663a8a790500f06b))
- Story单号：.NA
提交人：周韩杰
提交说明：1.组件库支持按需引入功能；2.新增radio组件；3.项目结构优化和目录调整； - ([2bf0a5b](https://github.com/xiyure/k-component-lib/commit/2bf0a5b479216ee192160c48f7d2bb230e37cacb))
- Story单号：.NA
提交人：周韩杰
提交说明：1.新增switch组件；2.接口命名优化； - ([608b18b](https://github.com/xiyure/k-component-lib/commit/608b18b4e95e656e0a2a0c18439a6a304dd8f99a))
- Story单号：.NA
提交人：周韩杰
提交说明：1.新增分页组件；2.组件库install函数修改；3.eslint校验规则完善； - ([31cb473](https://github.com/xiyure/k-component-lib/commit/31cb47370914fac4d61609bc3899a475d6d7f390))
- 1.readme文件修改 - ([44e33c4](https://github.com/xiyure/k-component-lib/commit/44e33c4e56dab283f14fde0bf79a8e948beb1e84))
- Story单号：.NA
提交人：周韩杰
提交说明：1.项目工程新建；2.新增button、tab、input、inputNumber组件； - ([d9dd258](https://github.com/xiyure/k-component-lib/commit/d9dd258ec2bf95d31b3859ae25ee5623ff889b41))
- Initial commit - ([d4cab85](https://github.com/xiyure/k-component-lib/commit/d4cab85fe42ca876079f256a39273ae761619c06))

### 🚜 重构

- 重构 tag 样式, 添加自定义颜色 - ([b49f70a](https://github.com/xiyure/k-component-lib/commit/b49f70a406a3cb7437e35890a5ee92a3a0b61646))
- 重构 input 样式 - ([daeead1](https://github.com/xiyure/k-component-lib/commit/daeead1f16a9f72c08de4b6a5a903d224b3a0e1d))
...
- 文档配置tailwind - ([9c3db5c](https://github.com/xiyure/k-component-lib/commit/9c3db5c5c9b10af28452960114f7b03e0699c8ba))
...
- Docs修改option - ([e09f911](https://github.com/xiyure/k-component-lib/commit/e09f91103fa5c64540ad61cc8f6d5cb2a48901d5))
- Docs应用组件api - ([0472913](https://github.com/xiyure/k-component-lib/commit/047291354985f0cc9f6aa2b87b29ca8b680feea1))
- Docs清除注释 - ([ed85639](https://github.com/xiyure/k-component-lib/commit/ed856393b8095bf6e6930b1ca676f3031ae2951b))
- 文档btn-lg尺寸bug - ([9472180](https://github.com/xiyure/k-component-lib/commit/94721807f926061e5c92d89928b2670024124237))
- Docs安装Vxe - ([ae17dff](https://github.com/xiyure/k-component-lib/commit/ae17dff409889ce4dc4ee13c079d2860b8dad7f8))
- 文档分离 - ([ef4cd1a](https://github.com/xiyure/k-component-lib/commit/ef4cd1ae51077083c57adc96d78e2f665d73ef82))

### 🎨 样式

- 样式隔离 - ([b1cd9a7](https://github.com/xiyure/k-component-lib/commit/b1cd9a72cd2b3bea04b232bdffb5df05870ed52d))

### 🧪 测试

- 测试 - ([2fcff5d](https://github.com/xiyure/k-component-lib/commit/2fcff5d08c4ce2447fd8f1dc82b2c2ff815ce960))
