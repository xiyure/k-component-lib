...
var DocSearchButton = ({
  ...
  return (() => {
    ...
    (0, import_web7.insert)(_el$, (() => {
      var _c$ = (0, import_web6.memo)(() => !!(hotKeys && hotKeys.length > 0));
      return () => _c$() && (() => {
        var _el$7 = _tmpl$22();
        (0, import_web7.insert)(_el$7, (0, import_web8.createComponent)(import_solid_js.For, {
          ...
          children: (k) => (() => {
            ...
            (0, import_web7.insert)(_el$8, (() => {
              var _c$2 = (0, import_web6.memo)(() => !!isCtrl(k));
              return () => _c$2() ? ctrlKey() : (0, import_web6.memo)(() => !!isAlt(k))() ? altKey() : k[0].toUpperCase() + k.slice(1);
            })());
            return _el$8;
          })()
        }));
...
var DownIcon = (props) => {
  return (() => {
    ...
    (0, import_web13.effect)((_p$) => {
      ...
      _v$ !== _p$.e && (0, import_web12.setAttribute)(_el$, "class", _p$.e = _v$);
      _v$2 !== _p$.t && (0, import_web12.setAttribute)(_el$, "aria-label", _p$.t = _v$2);
      return _p$;
    }, {
      e: void 0,
      t: void 0
...
var EnterIcon = (props) => {
  return (() => {
    ...
    (0, import_web16.effect)((_p$) => {
      var _v$ = props.class, _v$2 = props["aria-label"];
      _v$ !== _p$.e && (0, import_web15.setAttribute)(_el$, "class", _p$.e = _v$);
      _v$2 !== _p$.t && (0, import_web15.setAttribute)(_el$, "aria-label", _p$.t = _v$2);
      return _p$;
    }, {
      e: void 0,
      t: void 0
...
var EscIcon = (props) => {
  return (() => {
    ...
    (0, import_web19.effect)((_p$) => {
      var _v$ = props.class, _v$2 = props["aria-label"];
      _v$ !== _p$.e && (0, import_web18.setAttribute)(_el$, "class", _p$.e = _v$);
      _v$2 !== _p$.t && (0, import_web18.setAttribute)(_el$, "aria-label", _p$.t = _v$2);
      return _p$;
    }, {
      e: void 0,
      t: void 0
...
var UpIcon = (props) => {
  return (() => {
    ...
    (0, import_web28.effect)((_p$) => {
      var _v$ = props.class, _v$2 = props["aria-label"];
      _v$ !== _p$.e && (0, import_web27.setAttribute)(_el$, "class", _p$.e = _v$);
      _v$2 !== _p$.t && (0, import_web27.setAttribute)(_el$, "aria-label", _p$.t = _v$2);
      return _p$;
    }, {
      e: void 0,
      t: void 0
                ...
                (0, import_web50.insert)(_el$20, (0, import_web51.createComponent)(import_solid_js6.For, {
                  ...
                  children: (hit) => (() => {
                    ...
                    (0, import_web48.effect)((_p$) => {
                      ...
                      _v$ !== _p$.e && (0, import_web49.setAttribute)(_el$21, "aria-selected", _p$.e = _v$);
                      _v$2 !== _p$.t && (0, import_web49.setAttribute)(_el$21, "id", _p$.t = _v$2);
                      _v$3 !== _p$.a && _el$21.classList.toggle("docsearch-modal-search-hits-item--active", _p$.a = _v$3);
                      _v$4 !== _p$.o && (0, import_web49.setAttribute)(_el$22, "href", _p$.o = _v$4);
...
var DocSearch = (props) => {
  ...
  return [(0, import_web55.createComponent)(DocSearchButton, {
    ...
    hotKeys,
    onClick
  }), (0, import_web54.memo)(() => (0, import_web54.memo)(() => !!isOpen())() && (0, import_web55.createComponent)(import_web56.Portal, {
    get mount() {
