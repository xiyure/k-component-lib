<!--
* @description  参数1
* @fileName  message_window
* @author userName
* @date 2025-01-07 09:16:15
* @version V3.0.0
!-->
<template>
  <div
  ...
  >
    ...
    >
      ...
      <div class="close_btn">
        <k-button class="">View</k-button>
      </div>
    </div>
    <div class="message_window_footer flex items-center justify-center px-4 py-3 bg-white">
      <k-button class="!w-full">View All</k-button>
    </div>
  </div>
</template>
